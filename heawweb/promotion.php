    ...
    <section class="archive-area section_padding_80">
        <div class="container">
            <div class="row">
              ...
              <?php
                while($pro = $restQuerySQL->fetch_assoc()){
                  $id = $pro["R_ID"];
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="post-content">
                           ...
                           <font style="background-color:yellow;" color="black">  <?php echo $pro["P_NAME"];?></font> <br>

                          Description : <?php echo $pro["P_DESCRIPTION"];?> <br>
                          Date : <?php
                          echo date("F j, Y", strtotime($pro["P_START"]));?> - <?php echo date("F j, Y", strtotime($pro["P_END"]));?>
                        </div>
                    </div>
                </div>
                  <?php }
