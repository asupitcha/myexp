                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 item">
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s">
                            <h2 class="contact-form-title mb-30">Add menu</h2>
                            <!-- Contact Form -->
                            <form action="check_addmenu.php" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="rname" placeholder="Restaurant name">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="mname" placeholder="Menu name">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="mprice" placeholder="Price">
                                </div>
