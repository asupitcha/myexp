            ...
            <div class="row">
              ...
              <?php
                  ...
                  while ($rest = $restQuerySQL->fetch_assoc()) {
                    if($size == 0){
                      $type[0] = $rest["R_SUBTYPENAME"];
                      $size = count($type);
                    }else{
                      for ($i=0; $i < $size ; $i++) {
                        if($type[$i] == $rest["R_SUBTYPENAME"]){
                          $check = false;
                          break;
                        }else{
                          $check = true;
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.1s">
                        <div class="post-content">
                            <a href="showtype.php?value_key=<?php echo $type[$x]; ?>" class="block2-name dis-block s-text3 p-b-5">
                              <h4 class="post-headline"><?php echo $type[$x];?></h4>
                           </a>
                        </div>
                    </div>
                </div>
