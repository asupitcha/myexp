<?php
  ...
  $sql = "SELECT * FROM restaurant ORDER BY RAND() LIMIT 4";
...
<body>
    ...
    <section class="welcome-post-sliders owl-carousel">
        ...
        <div class="welcome-single-slide">
            <!-- Post Thumb -->
            <img src="img/restaurant/<?php echo $rest["R_PIC"];?>" alt="" class="center">
            <!-- Overlay Text -->
            <div class="project_title">
                <a href="detail.php?value_key=<?php echo $i ?>" class="block2-name dis-block s-text3 p-b-5">
                  <h5 class="post-headline"><?php echo $rest["R_NAME"];?></h5>
               </a>
            </div>
        </div>
        <?php } ?>
