            ...
            <div class="contact-form-area">
                <div class="row">
                    <div class="col-12 col-md-5">
                        <div class="contact-form-sidebar item wow fadeInUpBig" data-wow-delay="0.3s" style="background-image: url(img/catagory-img/3.jpg);">
                        </div>
                    </div>
                    <div class="col-12 col-md-7 item">
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s">
                            <h2 class="contact-form-title mb-30">Add promotion</h2>
                            <!-- Contact Form -->
                            <form action="check_addpro.php" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="rname" placeholder="Restaurant name">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="pname" placeholder="Promotion name">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="description" cols="30" rows="10" placeholder="Description"></textarea>
                                </div>
                                <div class="form-group">
                                  Start date <input type="date" class="form-control" name="start" placeholder="start">
                                </div>
                                <div class="form-group">
                                  End date  <input type="date" class="form-control" name="end" placeholder="end">
                                </div>
