			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="pagination flex-m flex-w p-t-26">
						<a href="product.php" class="item-pagination flex-c-m trans-0-4 active-pagination">1</a>
						<a href="page2.php" class="item-pagination flex-c-m trans-0-4">2</a>
					</div>
				</div>
			</div>
		</div>
