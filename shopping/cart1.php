						...
						<?php
							...
							//
												...
												echo '<tr class="table-row">';
														...
														echo '<td class="column-3">1</td>';

													echo '<td class="column-4">'.$p_price.'฿</td>';

														echo '<th class="column-6">';

													echo'	<form action="cart.php" method="POST">';
															echo'	<button class="flex-c-m size7 bg1 bo-rad-23 hov1 s-text1 trans-0-4"name='.$aaa[$i].'>-';
															echo'		</button>';


													if( isset($_POST[$aaa[$i]]) ){
														$remove =  $aaa[$i];
															 // echo ".$remove.";
															 	$_SESSION['myCart'] = "";
															 	for ($i=0; $i<$bb; $i++) {
																	if(strcmp($remove,$aaa[$i])!=0){
																		//not equal
																		 // $temp =
																		 	$_SESSION['myCart'].= $aaa[$i]." ";
...
?>
			...
			<div class="flex-w flex-sb-m p-t-25 p-b-25 bo8 p-l-35 p-r-60 p-lr-15-sm">
				<div class="flex-w flex-m w-full-sm">
					<div class="size12 trans-0-4 m-t-10 m-b-10 m-r-10">
						...
						<button class="flex-c-m size14 bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="flag">cancel
							<?php
			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				...
				<div class="flex-w flex-sb-m p-t-26 p-b-30">
					<span class="m-text22 w-size19 w-full-sm">	VAT	</span>
		...
		<!--			<input type="submit" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" value="check out" onclick="showDetail.php">-->
					<button type="button" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" onclick="">check out
						<?php
							$use = 	$_SESSION['user'];
							echo $use->getUserID();
							?>out
					</button>
					<input type="button" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" value="check out" onclick="window.location.href='showDetail.php'">
